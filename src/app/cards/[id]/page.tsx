...
export default function CardDetailPage({ params }: Props) {
    ...
    const handleInstallmentSubmit = async (e: React.FormEvent) => {
        ...
        const updatedInstallments = [...(card.installments || []), newInstallment];
        // Calculate the DEBT IMPACT.
        // Usually, the total amount is added to the balance immediately.
        const newCurrentBalance = card.currentBalance + total;
            ...
            <div className="max-w-lg mx-auto px-4 -mt-10 space-y-6">
                ...
                <div>
                    <div className="flex justify-between items-end mb-2 px-1">
                        ...
                        <button
                            onClick={() => setActionModal('installment')}
                    ...
                    <InstallmentList installments={card.installments} currency={card.currency} onDelete={handleDeleteInstallment} />
                </div>
                    ...
                    <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        <div className="bg-slate-50 p-4 border-b border-slate-100 flex justify-between items-center">
                            <h3 className="font-bold text-lg text-slate-800">
                                ...
                                {actionModal === 'installment' && 'Nueva Cuota'}
                            </h3>
                                    ...
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                // If switching back to auto, clear manual overrides if any or just let effect run
                                            }}
